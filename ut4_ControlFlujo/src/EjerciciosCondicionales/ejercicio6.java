...
public class ejercicio6 {
	...
	public static void main(String[] args) {
        ...
        if (ph>3.0 && ph<=7.0) {
            JOptionPane.showMessageDialog(null, "El compuesto es ácido (PH menor de 7.0)");
        }
            
        if (ph<=3.0) {
            JOptionPane.showMessageDialog(null, "El compuesto es peligrosamente ácido (PH menor de 3.0)");
        }
